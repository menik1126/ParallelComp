...
bash run_test_infinitebench_multi_gpu_window8_other.sh \
    ...
    --in_eager_mode False --calibration_stage head1_prefill_2_calibration_0_3 --calibration_mode 1
...
bash run_test_infinitebench_multi_gpu_window8_other.sh \
    ...
    \
    --attn_avg False --input_stitching False \
    --in_eager_mode False --calibration_stage head1_prefill_2_calibration_0_3 --calibration_mode 11
...
bash run_test_infinitebench_multi_gpu_window8_other.sh \
    ...
    \
    --attn_avg False --input_stitching False \
    --in_eager_mode False --calibration_stage head1_prefill_2_calibration_4_7 --calibration_mode 1
...
bash run_test_infinitebench_multi_gpu_window8_other.sh \
    ...
    \
    --attn_avg False --input_stitching False \
    --in_eager_mode False --calibration_stage head1_prefill_2_calibration_4_7 --calibration_mode 11
...
bash run_test_infinitebench_multi_gpu_window8_other.sh \
    ...
    \
    --attn_avg False --input_stitching False \
    --in_eager_mode False --calibration_stage head1_prefill_2_calibration_0_7 --calibration_mode 11
