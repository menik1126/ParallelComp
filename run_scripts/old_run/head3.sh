...
bash run_test_longbench_multi_gpu_window8.sh \
    ...
    \
    --attn_avg False --input_stitching False \
    --in_eager_mode False --calibration_stage head3_prefill_2_calibration_3_6  --calibration_mode 1
...
bash run_test_longbench_multi_gpu_window8.sh \
    ...
    \
    --attn_avg False --input_stitching False \
    --in_eager_mode False --calibration_stage head3_prefill_2_calibration_28_31  --calibration_mode 1
...
bash run_test_longbench_multi_gpu_window8.sh \
    ...
    \
    --attn_avg False --input_stitching False \
    --in_eager_mode False --calibration_stage head3_prefill_2_calibration_8_15  --calibration_mode 1
...
bash run_test_longbench_multi_gpu_window8.sh \
    ...
    \
    --attn_avg False --input_stitching False \
    --in_eager_mode False --calibration_stage head3_prefill_2_calibration_0_15  --calibration_mode 1